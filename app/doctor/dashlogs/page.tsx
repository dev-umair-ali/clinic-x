...
import { fetchDoctorAuditLogs, fetchAuditLog, clearSelectedLog } from "@/lib/slices/auditLogSlice";
...
export default function LogsPage() {
  ...
  useEffect(() => {
    ...
    params.doctorRef = user?.doctorId || "";

    dispatch(fetchDoctorAuditLogs(params));
