  ...
  const fetchCurrentDoctor = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Set current doctor as default provider
        if (data.user) {
          setFormData(prev => ({
            ...prev,
            provider: data.user._id || data.user.id,
          }));
        }
      }
    } catch (error) {
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="border-t pt-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-2xl font-bold text-[#1DA68F]">${subtotal.toFixed(2)}</span>
                        </div>
                      </div>
                    ...
                    <div className="pt-4 space-y-2 border-t">
                      ...
                      >
                        ...
                        {submitting ? "Saving..." : "Save & Submit Charge"}
                      </Button>
                      <Button
                        type="button"
                        variant="outline"
