              ...
              <CardContent className="p-0">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button className="px-4 py-2 rounded-md flex items-center space-x-2 text-[hsl(var(--foreground))] hover:bg-[hsl(var(--muted))] border border-[hsl(var(--border))] bg-[hsl(var(--background))]">
                    ...
                    <Button className="px-4 py-2 rounded-md flex items-center space-x-2 text-[hsl(var(--color-status-error))] hover:bg-[hsl(var(--color-status-error)/0.1)] border border-[hsl(var(--color-status-error)/0.3)] bg-[hsl(var(--background))]">
    ...
    <div className="min-h-screen bg-[hsl(var(--background))] p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg p-6">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <h2 className="text-lg font-semibold text-[hsl(var(--foreground))]">Audio Upload</h2>
            </div>
            <div
            ...
            >
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-[hsl(var(--foreground))] mb-2">Upload audio file</h3>
          ...
          <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg p-6">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <h2 className="text-lg font-semibold text-[hsl(var(--foreground))]">Generated Summary</h2>
            </div>
        ...
        <div className="flex flex-wrap justify-end gap-3 mb-8">
          ...
          <Button variant="outline" className="px-6 py-2 rounded-md border-[hsl(var(--border))] text-[hsl(var(--foreground))] hover:bg-[hsl(var(--muted))] flex items-center space-x-2">
            <span>✏️</span>
            <span>Edit</span>
          </Button>
          <Button variant="outline" className="text-[hsl(var(--color-status-error))] border-[hsl(var(--color-status-error)/0.3)] hover:bg-[hsl(var(--color-status-error)/0.1)] px-6 py-2 rounded-md flex items-center space-x-2">
            <span>🗑️</span>
            <span>Delete</span>
          </Button>
        </div>
