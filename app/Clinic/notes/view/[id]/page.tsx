                ...
                <div className="min-h-screen bg-[hsl(var(--background))] p-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center py-12">
                            ...
                            <Button
                                onClick={() => router.push("/clinic/notes")}
            ...
            <div className="min-h-screen bg-[hsl(var(--background))] p-6">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-8">
                        ...
                        >
                            {note?.appointmentRef?.status ? note.appointmentRef.status.charAt(0).toUpperCase() + note.appointmentRef.status.slice(1) : "Unknown Status"}
                        </Badge>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        ...
                        <Card className="border border-[hsl(var(--border))]">
                            <CardContent className="p-6">
                                ...
                                {note?.cptCodeRef && note.cptCodeRef.cpt_codes && note.cptCodeRef.cpt_codes.length > 0 ? (
                                    <div className="space-y-3">
                                        ...
                                        <div className="bg-[hsl(var(--muted)/0.5)] p-4 rounded-lg border border-[hsl(var(--border))]">
                                            <div className="space-y-2">
                                                ...
                                                {note.cptCodeRef?.cpt_codes?.map((code: any) => (
                                                    <>
