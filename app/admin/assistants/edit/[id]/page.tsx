...
import { updateAssistant, fetchAssistant } from "@/lib/slices/assistantSlice";
...
export default function EditAssistantPage() {
  ...
  const { assistant, loading: assistantsLoading } = useSelector(
  ...
  // Populate form data when single assistant is loaded
  useEffect(() => {
    if (assistant && assistant._id === assistantId) {
      setFormData({
        firstName: assistant.firstName || "",
        lastName: assistant.lastName || "",
        email: assistant.email || "",
        phoneNumber: assistant.phoneNumber || "",
        age: assistant.age?.toString() || "",
        ...
        address: {
          ...
          zipCode: assistant.address?.zipCode || "",
          country: assistant.address?.country || "USA",
        },
        department: assistant.department || "",
        position: assistant.position || "",
        clinicRef: assistant.clinicRef || "",
        profilePicture: assistant.profilePicture || "",
      });
      setProfileImage(assistant.profilePicture || null);
    }
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const response = await dispatch(
        updateAssistant({ id: assistantId, assistantData })
      );
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-[hsl(var(--muted-foreground))]">
                  Update assistant information and settings
                </p>
              </div>
            </div>
          </div>
