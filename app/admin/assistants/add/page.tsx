...
import { createAssistant } from "@/lib/slices/assistantSlice";
...
export default function AddAssistantPage() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const response = await dispatch(createAssistant(assistantData));
      if (response.meta.requestStatus === "fulfilled") {
        ...
        router.push(
          "/admin/assistants/view/" + (response?.payload as any)?.assistant?._id
        );
