...
import { createClinicPatient } from "@/lib/slices/clinicPatientSlice";
...
import { CreateClinicPatientRequest } from "@/lib/api/services/clinicPatientService";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await dispatch(
        createClinicPatient(payload as unknown as CreateClinicPatientRequest)
      );
      if (res.meta.requestStatus === "fulfilled") {
        toast({ title: "Success", description: "Patient added!", variant: "default" });
        router.push("/clinic/patients/view/" + (res.payload as any)._id);
      } else {
        toast({
          title: "Error",
