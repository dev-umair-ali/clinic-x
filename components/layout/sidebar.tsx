...
import { LayoutDashboard, Calendar, Users, CreditCard, FileText, StickyNote, Settings, LogOut, HelpCircle, MessageCircle, ArrowRight } from 'lucide-react';
...
const menuItems = {
  ...
  doctor: [
    ...
    { icon: CreditCard, label: "Patient Billing", href: "/doctor/billing" },
    { icon: FileText, label: "Prescription", href: "/doctor/prescription" },
    { icon: StickyNote, label: "Patient Notes", href: "/doctor/notes" },
    { icon: CreditCard, label: "Billing", href: "/doctor/billing-overview" },
  ],
  patient: [
