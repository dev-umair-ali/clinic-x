...
export default function ClinicAddress({ data, onChange }: ClinicAddressProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="state" className="text-[hsl(var(--foreground))]">
              State / Province <span className="text-[hsl(var(--destructive))]">*</span>
            </Label>
            <Input
              id="state"
              value={data.state}
          ...
          <div className="space-y-2">
            <Label htmlFor="zipCode" className="text-[hsl(var(--foreground))]">
              ZIP / Postal Code <span className="text-[hsl(var(--destructive))]">*</span>
            </Label>
            <Input
              id="zipCode"
              value={data.zipCode}
