          ...
          <div className="space-y-2 text-sm">
            {patient.phone && (
              <div className="flex items-center gap-2">
                ...
                <span className="truncate text-foreground">{patient.phone}</span>
              </div>
            )}
            {patient.email && (
              <div className="flex items-center gap-2">
            ...
            {patient.address && (
              <div className="flex items-center gap-2">
                <span className="text-muted-foreground">📍</span>
                <span className="text-xs sm:text-sm text-foreground">{patient.address}</span>
              </div>
            )}
            {patient.dateOfBirth && (
              <div className="flex items-center gap-2">
                <span className="text-muted-foreground">🎂</span>
                <span className="text-foreground">DOB: {fmt(patient.dateOfBirth)}</span>
              </div>
            )}
          </div>
        </div>
