...
import {
  updateAssistantPatientStatus,
  fetchAssistantPatients,
...
export function PatientTable({
  ...
  return (
    <>
      <Toaster />
      <div className="bg-[hsl(var(--background))] dark:bg-[hsl(var(--background))] rounded-xl shadow-md border border-[hsl(var(--border))] dark:border-[hsl(var(--border))]">
        {/* Table */}
         ...
         : "bg-[hsl(var(--color-status-error-light))] dark:bg-[hsl(var(--color-status-error-light))] text-[hsl(var(--color-status-error))] dark:text-[hsl(var(--color-status-error))]"
                  ...
                  <td className="px-6 py-4">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="bg-[hsl(var(--background))] dark:bg-[hsl(var(--background))] shadow-lg rounded-md"
                      >
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(
                              `/assistant/patients/view/${patient._id}`,
                            )
                          }
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(
                              `/assistant/patients/edit/${patient._id}`,
                            )
                          }
                          className="cursor-pointer"
                        >
